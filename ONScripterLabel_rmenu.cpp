...
static const char* messages[][8] = {
    { "`%s%s    Date %s/%s    Time %s:%s",
      ...
      "Yes",
      "No" },
    { (const char *)jp_messages::datetime,
      (const char *)jp_messages::spacing,
      (const char *)jp_messages::saving,
      (const char *)jp_messages::loading,
      (const char *)jp_messages::return_to_title,
      (const char *)jp_messages::quit,
      (const char *)jp_messages::yes,
      (const char *)jp_messages::no }
};
